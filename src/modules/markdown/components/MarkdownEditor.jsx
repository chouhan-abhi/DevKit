    ...
    <div className="h-full w-full flex flex-col min-h-0" style={{ background: "var(--bg-color)" }}>
      <div className="p-3 pb-0">
        <SubAppToolbar
          ...
          rightActions={
            <>
              <button onClick={formatMarkdown} className="toolbar-btn compact" type="button" data-tooltip="Format" aria-label="Format">
                <Sparkles size={14} />
              </button>
              ...
              <button onClick={handleExport} className="toolbar-btn compact" type="button" data-tooltip="Export .md" aria-label="Export">
                <Download size={14} />
              </button>
